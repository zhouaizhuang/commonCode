...
import { getApp } from './lib/plugin-compat.js'
    ...
    saveImgToLocal() {
      ...
      setTimeout(() => {
        wx.canvasToTempFilePath({
          canvasId: 'k-canvas',
          fileType : this.properties.palette.fileType || 'png',
          destWidth : parseInt(this.properties.palette.width),
          destHeight : parseInt(this.properties.palette.height),
