import CwPost from "./cw-post";
import { hideLoading, showLoading, showToast } from '../../common';
Page({
  imagePath: '',
  history: [],
  future: [],
  ...
  onLoad: function (options) {
    // const { type, avatar, userName, xcx_share_pic, title } = options
    showLoading('海报生成中')
  ...
  onReady: function() {
    this.setData({
      paintPallette: new CwPost().palette(),
